...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<!----------start of code--------------------------------------------------->
<div class="row box card upload-file-section">
	...
	<div class="box card ng-scope" ng-if="ctrl.Loan.isStudentLoanRefinance()">
		...
		<div class="section ng-pristine ng-invalid ng-invalid-required ng-valid-maxlength ng-valid-max ng-valid-parse ng-invalid-min ng-valid-pattern" ng-form="details_form">
			...
			<div class="row input-row ng-pristine ng-scope ng-isolate-scope ng-invalid ng-invalid-required ng-valid-parse" ng-form="Users_business_name">
				...
				<!-- end ngIf: !ctrl.userData.is_immutable && !expiredRate -->
				<div class="row cash_advance input-row ng-pristine ng-isolate-scope ng-invalid ng-invalid-required" ng-form="latest_degree" style="display:<?php ($model->cash_advance == 'Yes')?'block':'none';?>">
				...
				<div class="row cash_advance input-row ng-pristine ng-isolate-scope ng-invalid ng-invalid-required" ng-form="latest_school" style="display:<?php ($model->cash_advance == 'Yes')?'block':'none';?>">
				...
				<?php /*<div class="row input-row ng-pristine ng-isolate-scope ng-invalid ng-invalid-required ng-valid-max ng-valid-parse ng-invalid-min" >
