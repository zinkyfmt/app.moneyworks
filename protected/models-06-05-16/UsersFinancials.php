...
class UsersFinancials extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, user_id, gross_annual_sales, cash_advance, cash_advance_with, balance, current_credit_card_processor, avg_processing_volume, last_month_vol, second_month_vol, third_month_vol, fourth_month_vol', 'safe', 'on'=>'search'),
		);
	}
