...
class UsersPersonalInfo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('owner_1_name, owner_1_title, owner_1_dob, owner_1_ssn, owner_1_home_address, owner_1_home_phone, owner_1_cell_phone, owner_1_email, owner_1_own_or_rent, owner_1_payment, owner_1_years_there, owner_1_drivers_license, owner_1_drivers_license_state', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'user_id' => 'User',
			'owner_1_name' => 'Owner 1 Name',
			'owner_1_title' => 'Owner 1 Title',
			'owner_1_dob' => 'Owner 1 Dob',
			'owner_1_ssn' => 'Owner 1 Ssn',
			'owner_1_home_address' => 'Owner 1 Home Address',
			'owner_1_home_phone' => 'Owner 1 Home Phone',
			'owner_1_cell_phone' => 'Owner 1 Mobile Phone',
			'owner_1_email' => 'Owner 1 Email',
			'owner_1_own_or_rent' => 'Owner 1 Own Or Rent',
			'owner_1_payment' => 'Owner 1 Payment',
			'owner_1_years_there' => 'Owner 1 Years There',
			'owner_1_drivers_license' => 'Owner 1 Drivers License',
			'owner_1_drivers_license_state' => 'Owner 1 Drivers License State',
