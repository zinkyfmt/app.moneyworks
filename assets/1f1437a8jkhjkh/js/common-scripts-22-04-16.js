...
(function($) {
  $(function() {
    ...
    $(function() {
      ...
      $(".amount").html("$" + formatComma2(parseInt(value) * 5));
      $(".fam1").html("$" + formatComma2(parseInt(value) * 0.43));
      $(".lam1").html("$" + formatComma2(parseInt(value) * 0.44));
      $(".fam2").html("$" + formatComma2(parseInt(value) * 0.33));
      $(".lam2").html("$" + formatComma2(parseInt(value) * 0.34));
      $(".fam3").html("$" + formatComma2(parseInt(value) * 0.23));
      $(".lam3").html("$" + formatComma2(parseInt(value) * 0.24));
