...
class Users extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('agent_id,business_name, email, password, fname, lname, phone_number,  gross_annual_sales, years_in_business, is_sole_owner, does_lease_or_own, is_current_with_payments, has_federal_liens, is_on_payment_plan, has_current_balance', 'required'),
