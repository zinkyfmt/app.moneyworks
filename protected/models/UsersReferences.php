...
class UsersReferences extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, user_id, bank_name_branch, bank_name_branch_contact, bank_name_branch_phone, trade_reference_1, trade_reference_1_contact, trade_reference_1_phone, trade_reference_2, trade_reference_2_contact, trade_reference_2_phone, trade_reference_3, trade_reference_3_contact, trade_reference_3_phone', 'safe'),
		);
	}
