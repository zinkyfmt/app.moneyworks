  ...
  $(function() {
    ...
    $('#tab-wrapper a').click(function() {
      ...
      $(this).parent().addClass('selected');
		var fundingpurpose = $(this).find('span').html();
    ...
    $(function() {
      ...
      $("#rng").slider({
        ...
        slide: function(event, ui) {
          ...
          $(".amount").html("$" + formatComma2(ui.value * 1)+"k");
          $(".fam1").html("$" + formatComma2(ui.value * 1)+"k");
          $(".lam1").html("$" + formatComma2(ui.value * 1)+"k");
          $(".fam2").html("$" + formatComma2(ui.value * 1)+"k");
          $(".lam2").html("$" + formatComma2(ui.value * 1)+"k");
          $(".fam3").html("$" + formatComma2(ui.value * 1)+"k");
          $(".lam3").html("$" + formatComma2(ui.value * 1)+"k");
		  $("#Users_amount_needed").val("$" + formatComma2(ui.value * 1)+"k");
      ...
      $(".amount").html("$" + formatComma2(parseInt(value) * 1)+"k");
      $(".fam1").html("$" + formatComma2(parseInt(value) * 0.5)+"k");
      $(".lam1").html("$" + formatComma2(parseInt(value) * 0.5)+"k");
      $(".fam2").html("$" + formatComma2(parseInt(value) * 0.5)+"k");
      $(".lam2").html("$" + formatComma2(parseInt(value) * 0.5)+"k");
      $(".fam3").html("$" + formatComma2(parseInt(value) * 0.5)+"k");
      $(".lam3").html("$" + formatComma2(parseInt(value) * 0.5)+"k");
	  ...
	  $("#plus1").click(function () {
		...
		$("#rng").slider("value", value +1);
		$(".amount").html("$"+formatComma2(value + 1)+"k");
		$("#Users_amount_needed").val("$" + formatComma2(value+1)+"k");
	  });
