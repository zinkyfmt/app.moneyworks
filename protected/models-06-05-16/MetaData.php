...
class MetaData extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('slug', 'required'),
			array('slug, meta_title', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, slug, meta_title, meta_keywords, meta_description', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'categories' => array(self::HAS_MANY, 'Category', 'meta_id'),
		);
	}
