...
class Users extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('agent_id,business_name, email, password, fname, lname, phone_number,  gross_annual_sales, years_in_business, is_sole_owner, does_lease_or_own, is_current_with_payments, has_federal_liens, has_current_balance', 'required'),
			array('agent_id,business_name, fname, lname, phone_number,  gross_annual_sales, years_in_business, is_sole_owner, does_lease_or_own, is_current_with_payments, has_federal_liens, has_current_balance', 'required','on'=>'update'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'is_current_with_payments' => 'Are you current with payments?',
			...
			'balance_from_what_company' => 'From what company?',
			'balance_outstanding' => 'How much curretly outstanding',
			'best_time' => 'Best Time',
			'needs' => 'Needs',
		);
	}
