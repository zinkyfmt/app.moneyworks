...
(function($) {
  $(function() {
	...
	$(document).on('click','#UsersPersonalInfo_owner_1_own_or_rent',function(){
		var value = $(this).val();
		
		if(value == 'Rent'){
			$('.owner_1_payment').show();
		}
		else{ 
			$('#UsersPersonalInfo_owner_1_payment').val('');
			$('.owner_1_payment').hide();
		}
	});
	
	
	$(document).on('click','#UsersBizLocation_location',function(){
		var value = $(this).val();
		...
		if(value == 'Leased'){
			...
			$('#UsersBizLocation_lease_term').val('');
			$('#UsersBizLocation_monthly_rent').val('');
			$('.leased_owned').hide();
		}
	});
    ...
    $('input.cbtn,.icon-header-help.cbtn').click(function() {
