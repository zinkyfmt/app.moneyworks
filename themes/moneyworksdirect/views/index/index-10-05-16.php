		...
		<div class="section ng-pristine ng-invalid ng-invalid-required ng-valid-maxlength ng-valid-max ng-valid-parse ng-invalid-min ng-valid-pattern" ng-form="details_form">
                                  ...
                                  <div class="purpose-form">
                                    <div class="row slider-row">
                                      <div class="slider">
                                        ...
                                        <!-- ngIf: isMobileBrowser -->
                                        <div class="floor-value ng-binding">$10k</div>
                                        ...
                                        <div class="ceiling-value ng-binding">$500k+</div>
                                        <!-- ngIf: !isMobileBrowser -->
			...
			<div class="row input-row ng-pristine ng-isolate-scope ng-invalid ng-invalid-required ng-valid-maxlength" ng-form="education_dates">
				...
				<div class="row input-row ng-pristine ng-isolate-scope ng-invalid ng-invalid-required ng-valid-max ng-valid-parse ng-invalid-min" >
						...
						<?php echo $form->textField($model,'years_in_business',array('class'=>"ng-pristine ng-invalid ng-invalid-required ng-valid-parse ng-touched",'autocapitalize'=>"on", 'autocorrect'=>"off", 'placeholder'=>"", 'required'=>'required','maxlength'=>'4')); ?>
			...
			<div class="row input-row ng-pristine ng-scope ng-isolate-scope ng-invalid ng-invalid-required ng-valid-parse" ng-form="Users_agent_id">
				...
				<div class="select-list">
					<div class="info ng-isolate-scope" est-pop-up="" input="Users_agent_id" validation-message="ctrl.errorMessages.Users_agent_id">
						...
						<?php echo $form->dropDownList($model,'agent_id',Agents::model()->getAgents(),array('empty' => 'Select an Agent','class'=>"ng-pristine ng-invalid ng-invalid-required ng-valid-parse ng-touched", 'autocapitalize'=>"on", 'autocorrect'=>"off",'required'=>'required' )); ?>
			...
			<div class="row input-row ng-pristine ng-scope ng-isolate-scope ng-invalid ng-invalid-required ng-valid-parse" ng-form="Users_business_name">
				...
				<div class="row input-row ng-pristine ng-isolate-scope ng-invalid ng-invalid-required is_sole" style="display:<?php echo ($model->is_sole_owner=='0')?'block':'none';?>">
					...
					<div class="group">
						...
						<?php echo $form->textField($model,'percentage_share',array('class'=>" ng-pristine ng-invalid ng-invalid-required ng-valid-parse ng-touched",'autocapitalize'=>"on", 'autocorrect'=>"off",'ng-model'=>"ctrl.userData.last_name", 'placeholder'=>"Enter Share Info" )); ?>
				...
				<div class="row input-row ng-pristine ng-isolate-scope ng-invalid ng-invalid-required is_current_balance" style="display:<?php echo ($model->has_current_balance=='1')?'block':'none';?>" >
					...
					<div class="group">
						...
						<?php echo $form->textField($model,'balance_from_what_company',array('class'=>"ng-pristine ng-invalid ng-invalid-required ng-valid-parse ng-touched",'autocapitalize'=>"on", 'autocorrect'=>"off",'placeholder'=>"Enter Company Name")); ?>
				...
				<div class="row input-row ng-pristine ng-isolate-scope ng-invalid ng-invalid-required is_current_balance" style="display:<?php echo ($model->has_current_balance=='1')?'block':'none';?>;">
					...
					<div class="group">
						...
						<?php echo $form->textField($model,'balance_outstanding',array('class'=>"ng-pristine ng-invalid ng-invalid-required ng-valid-parse ng-touched",'autocapitalize'=>"on", 'autocorrect'=>"off",'ng-model'=>"ctrl.userData.last_name", 'placeholder'=>"Enter Amount" )); ?>
