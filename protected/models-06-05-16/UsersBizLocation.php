...
class UsersBizLocation extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('business_home_based, location, lease_term, monthly_rent, landlord_mortgage_co, landlord_mortgage_co_contact, landlord_mortgage_co_contact_phone, landlord_mortgage_co_contact_cell, landlord_mortgage_co_contact_email', 'required'),
