...
<div id="profile-widget-box">
	<div id="profile-widget">
		...
		<div class="widget-section <?php if(($controller == 'account' && $action =='financials') || CommonMethods::checkStepFilled(3)){ echo "active";}?>" >
			<div class="circle-box">
				<div class="circle"></div>
			</div>
		...
		<div class="widget-section <?php if(($controller == 'account' && $action =='bizlocation') || CommonMethods::checkStepFilled(5)){ echo "active";}?>" >
			...
			<a href="<?php echo Yii::app()->createUrl('account/bizlocation');?>">Biz Location</a>
		</div>
