    ...
    $(function() {
      ...
      $("#rng").slider({
        ...
        slide: function(event, ui) {
          ...
          $(".amount").html("$" + formatComma2(ui.value * 1));
          $(".fam1").html("$" + formatComma2(ui.value * 1));
          $(".lam1").html("$" + formatComma2(ui.value * 1));
          $(".fam2").html("$" + formatComma2(ui.value * 1));
          $(".lam2").html("$" + formatComma2(ui.value * 1));
          $(".fam3").html("$" + formatComma2(ui.value * 1));
          $(".lam3").html("$" + formatComma2(ui.value * 1));
		  $("#Users_amount_needed").val("$" + formatComma2(ui.value * 1));
      ...
      $(".amount").html("$" + formatComma2(parseInt(value) * 1));
      $(".fam1").html("$" + formatComma2(parseInt(value) * 0.5));
      $(".lam1").html("$" + formatComma2(parseInt(value) * 0.5));
      $(".fam2").html("$" + formatComma2(parseInt(value) * 0.5));
      $(".lam2").html("$" + formatComma2(parseInt(value) * 0.5));
      $(".fam3").html("$" + formatComma2(parseInt(value) * 0.5));
      $(".lam3").html("$" + formatComma2(parseInt(value) * 0.5));
	  ...
	  $("#plus1").click(function () {
		...
		$("#rng").slider("value", value +500);
		$(".amount").html("$"+formatComma2(value + 500));
		$("#Users_amount_needed").val("$" + formatComma2(value+500));
	  });
