...
class UsersBusinessInfo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('dba_name, legal_name, type_of_business, tax_id, business, business_address, full_billing_address, phone_at_location, best_phone, fax, business_email, website', 'required'),
